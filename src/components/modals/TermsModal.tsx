      ...
      >
        ...
        <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900">{TERMS_AND_CONDITIONS.title}</h3>
              <p className="text-sm text-slate-500">Last updated: {TERMS_AND_CONDITIONS.lastUpdated}</p>
            </div>
          </div>
          <button
            onClick={onClose}
